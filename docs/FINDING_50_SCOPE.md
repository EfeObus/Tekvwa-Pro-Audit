...
`recurring_journal_entries`, `gl_integration_logs`, `journal_entries` — done, verified (check
`docs/REMEDIATION_LOG.md` for current deploy status of the most recent one). 50 of the 66 tables in
