...
`goods_received_notes`, `goods_received_note_items` — done, verified (check
`docs/REMEDIATION_LOG.md` for current deploy status of the most recent one). 38 of the 66 tables
