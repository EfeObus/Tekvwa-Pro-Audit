...
`budget_line_items`, `audit_logs` — done, verified (check `docs/REMEDIATION_LOG.md` for current
deploy status of the most recent one). 3 of the 66 tables in the original scope remain (see the
