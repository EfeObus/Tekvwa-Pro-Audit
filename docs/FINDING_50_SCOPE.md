...
`recurring_journal_entries`, `gl_integration_logs` — done, verified (check
`docs/REMEDIATION_LOG.md` for current deploy status of the most recent one). 51 of the 66 tables in
