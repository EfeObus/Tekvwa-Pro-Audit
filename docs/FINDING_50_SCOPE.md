...
`upsell_opportunities`, `upsell_activities`, `payment_transactions` — done, verified (check
`docs/REMEDIATION_LOG.md` for current deploy status of the most recent one). 17 of the 66 tables
