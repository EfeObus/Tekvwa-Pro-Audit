...
`chart_of_accounts`, `fiscal_periods`, `exchange_rates` — done, verified (check
`docs/REMEDIATION_LOG.md` for current deploy status of the most recent one). 46 of the 66 tables in
